...
?>
<?php 
include('./Template/_home_slider_series.php');
?>
                                            ...
                                            ?>
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    <div class="product__item">
                                                        <div class="product__item__pic set-bg" data-setbg="<?=BASE_URL?>/uploads/serie_poster/<?=$item['img']; ?>">
                                                            <div class="ep"><?php
                                                        ...
                                                        <div class="product__item__text">
                                                            ...
                                                            <h5><a href="<?= BASE_URL ?>/genre_include/serie_details.php?series=<?= $item['slug'] ?>"><?= stripslashes($item['title']); ?></a></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php
