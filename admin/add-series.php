                    ...
                    <form action="code.php" method="POST" enctype="multipart/form-data">        
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" required name="creator" id="creator" placeholder="Enter creators" class="form-control">
                            </div>
                            <div class="col-md-5">
                            ...
                            <div class="col-md-10">
                                ...
                                <input type="text" required name="trailer" id="trailer" class="form-control max-width-300" placeholder="Enter the trailer URL" onchange="previewTrailer(this);">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" required name="duration" id="duration" placeholder="/Episode" class="form-control">
                            </div>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary" name="add_serie_btn">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
