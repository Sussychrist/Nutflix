    ...
    <div class="row">
        ...
        <?php 
                ...
                {       
                    ...
                    $movie = getId("content",$id);
                    
                    if(mysqli_num_rows($movie)>0)
                    {
                        $data = mysqli_fetch_array($movie);             
                        ?>
                            <div class="card">
                                        ...
                                        <div class="col-md-10">
                                                ...
                                                <?php 
                                                    ...
                                                    if (mysqli_num_rows($genre) > 0) 
                                                    {
                                                        ...
                                                        $selectedGenres = getSelectedStuff("content", $data['id'] , "movie_genre", "genre_id");
                                            ...
                                            <div class="col-md-5">
                                                <label>Select Quality </label>
                                                    <?php 
                                                        ...
                                                        {
                                                                $selectedQuality = getSelectedStuff("content", $data['id'] , "content_quality", "quality_id");
                                            ...
                                            <div class="col-md-10">
                                                <label>Select Region</label>
                                                    <?php 
                                                        ...
                                                        {
                                                            $selectedRegion = getSelectedStuff("content", $data['id'] , "movie_country", "country_id");
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" required name="director" value="<?= $data['director'] ?>" placeholder="Enter Directors" class="form-control">
                                            </div>
                                            <div class="col-md-5">
                                            ...
                                            <label for="old_image">Current Poster</label>
                                                ...
                                                <div class="square-image-container">
                                                    <img src="../uploads/movies_poster/<?= $data['img'] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                            ...
                                            <label for="old_wallpaper" class="mt-3" >Current Wallpaper</label>
                                                ...
                                                <div class="square-wallpaper-container">
                                                    <img src="../uploads/wallpaper/<?= $data['wallpaper'] ?>" />
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" name="trailer" id="trailer" class="form-control" placeholder="Enter the trailer URL" onchange="previewTrailer(this);">
                                            </div>
                                            <div class="col-md-5">  
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" name="video" id="video" class="form-control" placeholder="Enter the trailer URL" onchange="previewVideo(this);">
                                            </div>
                                            <div class="col-md-5">
                                                <label for="old_video" class="mt-3">Current Video URL</label>
                                                <input type="text" hidden name="old_video" id="old_video" class="form-control" value="<?= $data['video_url'] ?>" placeholder="Enter the video URL" onchange="previewVideo(this);">
                                                <div class="video-preview">
                                                    <video id="video-player" controls><source src="<?= $data['video_url'] ?>" type="video/mp4"></video>
                                                </div>
                                            </div> 
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" required name="duration" value="<?= $data['duration'] ?>" placeholder="Enter Duration" class="form-control">
                                            </div>
                                            <div class="col-md-8">
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary" name="update_movie_btn">Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
