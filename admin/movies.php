    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="button-container" style="text-align: right;">
                <a href="add-movie.php" class="btn btn-success" style="margin-right: 10px;"><i class="fa fa-solid fa-plus" style="color: #ffffff;"></i> Add New</a>
                <a href="index.php" class="btn btn-primary">Back</a>
            </div>
        </div>
        <div class="card-body" id="content_table">
            <table class="table table-bordered table-group-divider table-hover">
                ...
                <tbody>
                <?php
                $movies = getOrderAll($con, "content", "title ASC"); 
                if (mysqli_num_rows($movies) > 0) {
                    foreach ($movies as $item) {
                        ...
                        <tr>
                            <td>
                                <div class="movie_item">
                                    <div class="movie_item_pic">
                                        <img src="../uploads/movies_poster/<?= $item['img']; ?>" class="img-fluid rounded-2" alt="<?= $item['img']; ?>">
                            ...
                            <td style="width:60px">
                                <a href="edit-movie.php?id=<?= $item['id']; ?>" class="btn btn-primary">Edit</a>
                            </td>
                            <td style="width:60px">
                                <button type="button" class="btn btn-danger delete_movie_btn"
